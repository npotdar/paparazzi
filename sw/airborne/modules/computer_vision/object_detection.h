...
// Module functions
extern void object_detection_init(void);
extern void object_detection_start(void);
extern void object_detection_stop(void);
extern void object_detection_run(void);
